    ...
    .object({
        body: yup
            .object({
                ...
                orderBy: yup.string().trim().oneOf(['name', 'createdAt', 'updatedAt']).required(),
    ...
    .object({
        body: yup
            .object({
                ...
                sources: yup.array().of(yup.string().trim().max(1000).required()).required(),
                ...
                recipeSections: yup
                    ...
                    .required(),
                associatedRecipes: yup.array().of(yup.number().integer().min(1).required()).required(),
